          ...
          child: Row(
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Drag to pan · tap a table to inspect',
              ...
              IconBtn(
                ...
                iconSize: 16,
                onTap: () =>
                    setState(() => zoom = (zoom + 0.15).clamp(0.5, 1.6)),
              ),
            ...
            child: ClipRRect(
              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                    Positioned.fill(
                      child: CustomPaint(painter: _DotGridPainter(c.dot)),
                    ),
                    Positioned.fill(
                      child: GestureDetector(
                        ...
                        onPanUpdate: (d) {
                          if (_dragStart != null)
                            setState(
                              () => pan =
                                  _panStart! + (d.localPosition - _dragStart!),
                            );
                        },
                            ...
                            child: Stack(
                              ...
                              children: [
                                ...
                                Positioned(
                                  ...
                                  top: 0,
                                  child: CustomPaint(
                                    size: const Size(540, 620),
                                    painter: _RelPainter(
                                      cat: cat,
                                      center: (n) => _center(cat, n),
                                      relColors: rc,
                                    ),
                                  ),
                                ),
                                  ...
                                  (r) => Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '${r.from}→${r.to}',
                                          style: mono(size: 9, color: c.text3),
                                        ),
                                      ],
                                    ),
                                  ),
                  ...
                  if (t.columns.length > 4)
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: sans(size: 10, color: c.text4),
                      ),
                    ),
                ],
              ),
